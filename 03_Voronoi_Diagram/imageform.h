...
public:
    ...
    void            DrawPolygon(const QPolygonF& q_Polygon,const QColor& q_Color, int nWidth=1, QColor* q_pColorBrush=0);
    void            DrawPoints(const  QPolygon&  q_Polygon, const QColor&, int nWidth=1);
    void            DrawLine(int nXo,int nYo, int nX1, int nY1,const QColor& q_Color, int nWidth=1);
    void            DrawLines(const QPolygon& q_Polygon, const QColor& q_Color, int nWidth);
